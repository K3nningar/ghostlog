...
{
    /**
     * Liste paginée des spectres (catalogue).
     *
     ...
     * Les spectres sont les items classés `category_slug = ghosts` par
     * ItemClassifier (DestinyItemCategoryDefinition hash 39).
     */
    public function index(Request $request)
    {
        ...
        return Inertia::render('Ghosts/Index', [
            'ghosts' => $ghosts,
            'tiers' => $tiers,
            'filters' => [
                'search'        => $search,
